...
export const Footer = () => {
  return (
    <div className="w-full md:h-[499px] h-[846px] bg-[#f0f0f0] flex md:justify-center md:items-center flex-col md:mt-[150px] mt-[181.81px] relative ">
      <div className="md:max-w-[1240px] w-full md:py-[35px] md:-mt-35 -mt-[146.5px] max-md:px-4">
        <div className="w-full md:h-[180px] h-[293px] bg-black flex max-md:flex-col md:px-[64px] px-6 rounded-[20px] ">
          ...
          <div className="flex-1 flex flex-col justify-center items-center gap-[14px]">
            ...
            <div className=" md:w-[349px] w-full md:h-12 h-10.5">
      ...
      <div className="md:max-w-[1240px] w-full md:mt-[50px] max-md:mt-10 max-md:px-4">
        <div className="h-[1px] border-t border-gray-300"></div>
      </div>
      <div className="md:max-w-[1240px] w-full flex max-md:flex-col md:justify-between md:mt-[25px] mt-4 items-center">
