...
export const NewArrival = ({
  ...
  return (
    <div
      className={`flex flex-col md:h-[745px] md:max-w-[1240px] w-full items-center max-md:pb-10`}
    >
          ...
          data.items.map((item: Product) => (
            <>
              <div className="flex flex-col  ">
                <div className="max-w-[295px] max-h-[298px] mb-4 max-md:w-[198px] max-md:h-[200.01px]">
                  <img
